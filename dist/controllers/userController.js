...
exports.updateContactNumber = exports.userStatus = exports.getUsers = exports.logoutController = exports.signInController = exports.resetPassword = exports.userCreatePassword = exports.signupController = exports.isAdmin = exports.isSuperAdmin = void 0;
...
const isSuperAdmin = (req) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
...
const signupController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield (0, User_1.createUser)({ firstname, lastname, email, temp_password, role });
    ...
    `;
        ...
        // await sendEmail(
        email, "Welcome to UCPIP - Set Your Password", "Welcome to the UCPIP portal. Please click the link below to set your own password.", htmlContent);
...
const userCreatePassword = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (action === "update_password") {
            // update the password
            const updateForgotPassword = yield (0, User_1.updatePassword)(getUser.email, password);
        ...
        // create new password
        const createNewPassword = yield (0, User_1.createPassword)(getUser.email, password);
...
const resetPassword = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    `;
        ...
        const updateForgotPassword = yield (0, mailgun_1.sendEmail2)(getUser.email, "UCPIP Request Reset Password", "Please reset your password using the link below.", htmlContent);
        if (!updateForgotPassword) {
            return res.status(500).json({ message: "Something went wrong" });
        }
        return res
...
const signInController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!getUser) {
            ...
            if (email === process.env.FALLBACK_ADMIN &&
                password === process.env.FALLBACK_PASSWORD) {
                // Generate a token for the fallback admin
                const token = (0, jwt_1.generateToken)("fallback_admin", (_a = process.env.FALLBACK_ADMIN) !== null && _a !== void 0 ? _a : "");
        ...
        const checkIsUserPasswordAlreadyActivated = yield (0, User_1.isUserPasswordAlreadyActivated)(getUser.email);
...
const userStatus = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const isAdminUser = yield (0, exports.isAdmin)(req);
        if (!isAdminUser) {
            return res
...
const updateContactNumber = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const updateContactNumber = yield (0, User_1.updateUserContactNumber)(req.body);
